...
class ISFInsert
{
    ...
    function __invoke($data)
    {
        ...
        $req->bindParam(6, intval(preg_replace("/\W/", '', $data[4])), \PDO::PARAM_INT);
        $req->bindParam(7, intval(preg_replace("/\W/", '', $data[6])), \PDO::PARAM_INT);
        $req->bindParam(8, intval(preg_replace("/\W/", '', $data[5])), \PDO::PARAM_INT);
